...
<div class="navbar" style="width: auto;">
	<div class="navbar-inner">
		<div class="container">
			...
			</a> <a class="brand" href="#">E-civil</a>
			<div class="nav-collapse collapse">
				<ul class="nav">
					...
					<security:authorize access="isAuthenticated()">
						<li><a
							href="<spring:url value="/accidents.html" htmlEscape="true" />"><i
								class="icon-warning-sign"></i> <fmt:message
									key="navbar.menu.accidents" /></a></li>
						<li>
						<li><a
					...
					<security:authorize access="hasAnyRole('ROLE_ADMIN')">
						...
						<li><a
							href="<spring:url value="/users.html" htmlEscape="true" />"
							title="<fmt:message key="navbar.menu.users.title"/>"><i
								class="icon-user"></i> <fmt:message key="navbar.menu.users" /></a></li>
					</security:authorize>

					<security:authorize
						access="hasAnyRole('ROLE_INSTITUTIONS_ADMIN','ROLE_VOLUNTEERS_ADMIN')">
						<li><a
							href="<spring:url value="/users/manage.html" htmlEscape="true" />"><i
								class="icon-user"></i> <fmt:message
									key="navbar.menu.manageTeams" /></a></li>
						<li>
					</security:authorize>
